...
document.write("if (document.getElementById(\"main\") != undefined) {");
document.write("	if ( ( !document.getElementById(\"main\").hasAttribute(\"class\")) || (document.getElementById(\"main\").className!=\"nosidebar\") ) {");
