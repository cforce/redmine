  ...
  module Taggable
    module PostgreSQL
      def self.included(base)
        base.send :include, ActsAsTaggableContacts::Taggable::PostgreSQL::InstanceMethods
        base.extend ActsAsTaggableContacts::Taggable::PostgreSQL::ClassMethods
      
        ActsAsTaggableContacts::Tag.class_eval do
          def self.named(name)
