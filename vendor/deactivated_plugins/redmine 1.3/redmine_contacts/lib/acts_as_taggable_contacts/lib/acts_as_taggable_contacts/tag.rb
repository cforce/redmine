module ActsAsTaggableContacts
  class Tag < ::ActiveRecord::Base
    include ActsAsTaggableContacts::ActiveRecord::Backports if ::ActiveRecord::VERSION::MAJOR < 3
  
    attr_accessible :name

    ### ASSOCIATIONS:

    has_many :taggings, :dependent => :destroy, :class_name => 'ActsAsTaggableContacts::Tagging'
