...
module NewsSubscriptionPatch
    ...
    module InstanceMethods
        ...
        def recipients_with_subscribers
            ...
            notified += subscribers.select{ |subscriber| subscriber.subscribed_to?(:news) && visible?(subscriber.user) }.collect{ |subscriber| subscriber.user.mail }
        end
